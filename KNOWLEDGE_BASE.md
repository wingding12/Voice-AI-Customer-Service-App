...
This document contains all knowledge base articles used by the AI agents (voice and text) for customer service.
...
| ---------------- | -------------------------------------------- |
| BILLING          | Understanding bills, charges, and statements |
| PAYMENTS         | Payment methods, due dates, options          |
| ASSISTANCE       | Financial help, hardship programs            |
| OUTAGES          | Power outage reporting and safety            |
| EMERGENCY        | Gas leak procedures, CO safety               |
| NEW_SERVICE      | Starting service, connection fees            |
| TRANSFER_SERVICE | Moving, stopping service                     |
| METERS           | Smart meters, usage monitoring               |
| HIGH_BILL        | Bill investigation, usage analysis           |
| EFFICIENCY       | Rebates, energy saving programs              |
| DISCONNECTION    | Disconnection policies, reconnection         |
| CONTACT          | Phone numbers, hours, locations              |
...
Your utility bill includes several components:
...
We understand financial hardships happen. We offer several assistance options:
...
**⚠️ EMERGENCY: If you smell gas, act immediately!**
...
| Power Outage       | 1-800-OUT-LINE |
| Gas Emergency      | 1-800-GAS-LEAK |
| Payment by Phone   | 1-800-PAY-UTIL |
| New Service        | 1-800-NEW-SRVC |
...
| Fee                   | Amount          |
| --------------------- | --------------- |
| Late Payment          | 1.5% of balance |
| Standard Connection   | $35             |
| Same-Day Connection   | $75             |
| Reconnection          | $50             |
| Same-Day Reconnection | $100            |
| New Customer Deposit  | $200            |
| Phone Payment         | $2.50           |
| Smart Meter Opt-Out   | $75 + $25/mo    |

### Key Policies

| Policy               | Details                 |
| -------------------- | ----------------------- |
| Bill Due Date        | 21 days after statement |
| Auto-Pay Discount    | $2/month                |
| Senior Discount      | 15% (age 65+)           |
| Hardship Forgiveness | Up to $300              |
| Payment Plans        | 3-12 months             |
| Winter Protection    | Nov 1 - Mar 31          |

---

_Last Updated: December 2024_
_AI Customer Service Platform_
